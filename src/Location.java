...
//			Location leftLocation = new Location(n.getX()-2,n.getY(), 'N', 'l');
			Location leftLocation = new Location(n.getX()+1,n.getY()-3, 'N', 'l');
			//Location rightLocation = new Location(n.getX(),n.getY()+2, 'S', 'r');	
			Location rightLocation = new Location(n.getX()+3,n.getY()+5, 'S', 'r');
//			locationList.add(frontLocation);
//			locationList.add(backLocation);
//			backLocation.g = 5;
//			leftLocation.g = 5;
...
//			Location leftLocation = new Location(n.getX(),n.getY()-2, 'E', 'l');
			Location leftLocation = new Location(n.getX()+3,n.getY()+1, 'E', 'l');
//			Location rightLocation = new Location(n.getX()-2,n.getY(), 'W', 'r');
			Location rightLocation = new Location(n.getX()-5,n.getY()+3, 'W', 'r');
//			locationList.add(frontLocation);
//			locationList.add(backLocation);
//			backLocation.g = 10;
//			leftLocation.g = 5;
